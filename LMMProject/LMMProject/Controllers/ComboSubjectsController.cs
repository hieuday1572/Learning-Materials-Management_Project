...
{
    public class ComboSubjectsController : Controller
    {
        private readonly AppDbContext _context;

        public ComboSubjectsController(AppDbContext context)
        {
            _context = context;
        }
